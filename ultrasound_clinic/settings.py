...
MIDDLEWARE = [
    ...
    'patients.middleware.PrivilegeElevationMiddleware', # Add this middleware
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'patients.context_processors.elevation_context',
                'patients.context_processors.staff_notifications_context',
                'patients.context_processors.patient_notifications_context',
            ],
        },
    },
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ivan.sinaon21@gmail.com'  
EMAIL_HOST_PASSWORD = 'pidy kzdu bcnh kenf'  
