...
urlpatterns = [
    ...
    path('exam/<int:exam_id>/similar-examinations/', views.get_similar_examinations, name='get-similar-examinations'),
    ...
    path('api/exams/<int:exam_id>/auto-annotate/', api.auto_annotate_image, name='auto-annotate-image'),
    ...
    path('custom-admin/staff-analytics/<int:user_id>/', admin_views.admin_staff_analytics, name='admin_staff_analytics'),
